...
namespace Strawberry.MobileApp.Pages.Appeal
{
    ...
    public partial class AppealPage_Menu02_Template : DataTemplate
    {
        private LockDataModel LockData { get; set; } = new LockDataModel();

        public AppealPage_Menu02_Template()
        {
            InitializeComponent();
        }
        ...
        private async void Item_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var data = element.BindingContext as AppealPage_Menu02_Data;
        ...
        private async void ItemThumbnail_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (data == null)
                {
                    ...
                    data = element.BindingContext as AppealPage_Menu02_Data;
                }
