...
{
    public class Data_Join_CharmingPoint : BindableObject, IValueConverter
    {
        ...
        public static readonly BindableProperty ItemsProperty = BindableProperty.Create(nameof(Items), typeof(ObservableCollection<ItemData>), typeof(Data_Join_CharmingPoint));
