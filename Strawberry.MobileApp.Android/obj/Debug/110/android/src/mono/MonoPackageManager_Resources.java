...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Strawberry.MobileApp.Android.dll" comes first in this list. */
		"Strawberry.MobileApp.Android.dll",
		"Com.Kakao.Sdk.Auth.dll",
		"Com.Kakao.Sdk.Common.dll",
		"Com.Kakao.Sdk.Network.dll",
		"Com.Kakao.Sdk.Usermgmt.dll",
		"Com.Kakao.Sdk.Util.dll",
		"Com.Kakao.Sdk.Xamarin.Forms.dll",
		"ExoPlayer.Core.dll",
		"ExoPlayer.Dash.dll",
		"ExoPlayer.dll",
